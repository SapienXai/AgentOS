...
export function MissionControlShell({
  ...
  const { snapshot, connectionState, hasReceivedLiveSnapshot, gatewayReachable, cliInstalled, refresh, refreshSnapshot, setSnapshot } = useMissionControlData(initialSnapshot);
  const {
    activeWorkspaceId,
