...
- Install or select OpenClaw 2026.8.2 or newer, start its Gateway on loopback, and verify `openclaw gateway status --deep --json` reports protocol v4, operator auth, and approved operator scopes.
